      ...
      <ul>
        <li className="flex items-center hover:bg-[gray] hover:pl-[-5%]">
          <Link to="/dashboard/" className="flex items-center gap-3 pl-4 pb-2 pt-2">
            ...
            <h1 className='text-md'>Dashboard Home</h1>
          </Link>
        </li>
        <li className="flex items-center hover:bg-[gray]">
          <Link to="/dashboard/profile" className="flex gap-4 pl-4 pb-2 pt-2 items-center hover:text-gray-300">
            <CgProfile className="text-l hover:text-gray-300" />
