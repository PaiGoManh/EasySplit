...
const GroupProfile = () => {
    ...
    const fetchGroupData = async () => {
        try {
            const groupResponse = await fetch(`/api/group/getgroup/${id}`, {
                method: 'GET',
                credentials: 'include',
            });
    ...
    const fetchSplitsData = async () => {
        ...
        try {
            const splitsResponse = await fetch(`/api/groupexpense/splits/${id}`, {
                method: 'GET',
                credentials: 'include',
            });
    ...
    const handleModalSubmit = async () => {
        try {
            const response = await fetch(`/api/groupexpense/pay/${selectedDetail._id}`, {
                method: 'POST',
                headers: {
    ...
    const handleSettleClick = async (splitId) => {
        try {
            const response = await fetch(`/api/groupexpense/settle/${splitId}`, {
                method: 'POST',
                credentials: 'include',
            });
